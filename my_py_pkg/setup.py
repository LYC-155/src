...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            "robot_news_staion = my_py_pkg.robot_news_station:main",
            ...
            "compute_area_server = my_py_pkg.compute_area_server:main",
            "compute_area_client = my_py_pkg.compute_area_client:main",
