...
public:
    HardwareStatusPublisherNode() : Node("hardware_status_publisher")
    {
        ...
        timer_ = this -> create_wall_timer(1.5s, std::bind(&HardwareStatusPublisherNode::pubHardwareStatus, this));
        RCLCPP_INFO(this -> get_logger(), "hardware_status_publisher has been stated.");
    }

private:
    void pubHardwareStatus()
    {
        auto msg = my_robot_interfaces::msg::HardwareStatus();
        msg.temperature = 55;
        msg.are_motors_ready = true;
        msg.debug_message = "too hot!!!";
        pub_ -> publish(msg);
    }
